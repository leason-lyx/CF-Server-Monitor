...
async function fetchConfig() {
  try {
    ...
    return {
      ...
      node_5_name: data.node_5_name || 'Node 5',
      node_6_name: data.node_6_name || 'Node 6',
      node_7_name: data.node_7_name || 'Node 7',
      node_8_name: data.node_8_name || 'Node 8',
      version,
  ...
  return {
    ...
    node_1_name: 'Node 1', node_2_name: 'Node 2', node_3_name: 'Node 3', node_4_name: 'Node 4', node_5_name: 'Node 5', node_6_name: 'Node 6', node_7_name: 'Node 7', node_8_name: 'Node 8',
    display_mode: 'bar',
    preferred_theme: 'auto',
    default_language: 'auto',
    version: '',
